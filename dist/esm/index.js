    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 14:
          ...
          tmpDir = os.tmpdir();
          songPath = "".concat(tmpDir, "/").concat(randomBytes(3).toString('hex'), ".mp3");
          stream.on('error', function (err) {
            return console.log(err);
          });
          _context7.next = 22;
          return new Promise(function (resolve) {
            ffmpeg(stream).audioFrequency(44100).audioChannels(2).audioBitrate(128).audioCodec('libmp3lame').audioQuality(5).toFormat('mp3').save(songPath).on('end', function () {
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 13:
          ...
          tmpDir = os.tmpdir();
          videoPath = "".concat(tmpDir, "/").concat(randomBytes(3).toString('hex'), ".mp4");
          writeStream = fs.createWriteStream(videoPath);
          _iteratorAbruptCompletion = false;
          _didIteratorError = false;
          _context8.prev = 20;
          _iterator = _asyncIterator(Utils.streamToIterable(stream));
        case 22:
          _context8.next = 24;
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 13:
          ...
          tmpDir = os.tmpdir();
          tempVideoPath = "".concat(tmpDir, "/").concat(randomBytes(3).toString('hex'), ".mp4");
          videoWriteStream = fs.createWriteStream(tempVideoPath); // Gabungkan semua chunk menjadi satu file MP4 sementara
          _iteratorAbruptCompletion2 = false;
          _didIteratorError2 = false;
          _context9.prev = 19;
          _iterator2 = _asyncIterator(Utils.streamToIterable(stream));
        case 21:
          _context9.next = 23;
        ...
        case 45:
          ...
          songPath = "".concat(tmpDir, "/").concat(randomBytes(3).toString('hex'), ".mp3"); // Konversi file MP4 sementara menjadi MP3
          _context9.next = 49;
